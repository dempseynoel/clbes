...
The first of the compulsory arguments is ```data```, and takes the name of the BES dataset you have loaded into R. The second is ```dgraphic``` and is the name of the demographic characteristic variable of interest in the BES dataset. ```vote``` takes the name of the variable which captures whether the BES survey respondent said they voted in the election of interest. The fourth compulsory argument is ```wt``` which takes the name of the weighting variable to be used. 
